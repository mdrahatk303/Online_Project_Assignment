...
module.exports.allocateMail=function(user)
{
    // let htmlPage=nodemailer.rendertemplate({data:comment},'/comments/newComment.ejs');//.ejs must be used
    nodemailer.transporter.sendMail({
        from:`Project Allotment ${process.env.EMAIL}`,
        to:user.email,
        subject:"Project Allotment done",
        // html:htmlPage
                        ...
                        <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                            <tr>
                                ...
                                <td align="center" class="section-img">
                                    <a href="" style=" border-style: none !important; display: block; border: 0 !important;"><img src="https://content3.jdmagicbox.com/comp/ambala/y5/9999px171.x171.191228161720.l7y5/catalogue/electronics-and-electrical-school-college-projects-ambala-1copbc28ph.jpg?clr=1d3a49" style="display: block; width: 590px;" width="590" border="0" alt="" /></a>
                            ...
                            <tr>
                                <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                                    ...
                                    <div style="line-height: 35px">
                                        ...
                                        PROJECT IS NOW <span style="color: #5caad2;">ALLOTED</span>
                                        ...
                                        <tr>
                                            <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                ...
                                                <div style="line-height: 24px">
                                                    ...
                                                    Hey <h3>${user.name}</h3> Project allotment is now done and for details please visit the link given below.
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                                ...
                                                <div style="line-height: 26px;">
                                                    <a href="http://localhost:8000/" style="color: #ffffff; text-decoration: none;">VISIT</a>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <td>
                                    <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                        ...
                                        <tr>
                                            <!-- logo -->
                                            <td align="left">
                                                <a href="http://localhost:8000/" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" src="https://content3.jdmagicbox.com/comp/ambala/y5/9999px171.x171.191228161720.l7y5/catalogue/electronics-and-electrical-school-college-projects-ambala-1copbc28ph.jpg?clr=1d3a49" alt="" /></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                                <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                    ...
                                                    Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">project@gmail.com</a>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="center">
                                                            <a style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;color: #5caad2; text-decoration: none;font-weight:bold;" href="{{UnsubscribeURL}}"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
